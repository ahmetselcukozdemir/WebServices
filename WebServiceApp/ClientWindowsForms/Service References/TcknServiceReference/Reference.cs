...
namespace ClientWindowsForms.TcknServiceReference {
    ...
    public interface KPSPublicSoap {
        ...
        ClientWindowsForms.TcknServiceReference.TCKimlikNoDogrulaResponse TCKimlikNoDogrula(ClientWindowsForms.TcknServiceReference.TCKimlikNoDogrulaRequest request);
        bool TCKimlikNoDogrula(long tckn, string isim, string soyisim, int dogumyili);
        [System.ServiceModel.OperationContractAttribute(Action="http://tckimlik.nvi.gov.tr/WS/TCKimlikNoDogrula", ReplyAction="*")]
        System.Threading.Tasks.Task<ClientWindowsForms.TcknServiceReference.TCKimlikNoDogrulaResponse> TCKimlikNoDogrulaAsync(ClientWindowsForms.TcknServiceReference.TCKimlikNoDogrulaRequest request);
    }
    ...
    public partial class TCKimlikNoDogrulaRequest {
        ...
        public ClientWindowsForms.TcknServiceReference.TCKimlikNoDogrulaRequestBody Body;
        
        public TCKimlikNoDogrulaRequest() {
        }
        
        public TCKimlikNoDogrulaRequest(ClientWindowsForms.TcknServiceReference.TCKimlikNoDogrulaRequestBody Body) {
            this.Body = Body;
        }
    }
    ...
    public partial class TCKimlikNoDogrulaResponse {
        ...
        public ClientWindowsForms.TcknServiceReference.TCKimlikNoDogrulaResponseBody Body;
        
        public TCKimlikNoDogrulaResponse() {
        }
        
        public TCKimlikNoDogrulaResponse(ClientWindowsForms.TcknServiceReference.TCKimlikNoDogrulaResponseBody Body) {
            this.Body = Body;
        }
    }
    ...
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public interface KPSPublicSoapChannel : ClientWindowsForms.TcknServiceReference.KPSPublicSoap, System.ServiceModel.IClientChannel {
    }
    
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.ServiceModel", "4.0.0.0")]
    public partial class KPSPublicSoapClient : System.ServiceModel.ClientBase<ClientWindowsForms.TcknServiceReference.KPSPublicSoap>, ClientWindowsForms.TcknServiceReference.KPSPublicSoap {
